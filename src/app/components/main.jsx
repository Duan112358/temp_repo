...
let Main = React.createClass({
    ...
    render() {
        ...
        let ddmenuItems = [
           { payload: '1', text: '搜索全部' },
           { payload: '2', text: '搜索标签' },
           { payload: '3', text: '搜索短镜头' },
           { payload: '4', text: '搜索轻游记' }
        ];
            ...
            <div>
                <Paper zDepth={1} style={styles.toolbarWrapper}>
                    <Toolbar style={styles.toolbar}>
                        ...
                        <ToolbarGroup style={styles.toolbarGroup} key={1} float="right">
                            <DropDownMenu menuItems={ddmenuItems} style={{width:'122', marginRight:'0'}} underlineStyle={{display:'none'}}/>
